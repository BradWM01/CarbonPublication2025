...
\todo{For the following, perhaps just a summarisation will do as this is
expounded upon in modelling section}
...
\todo{For this I think we need more specififity, and maybe here is the 
place to talk about sample prep?}
...
\todo{The fallacy that channel porosity = open porosity is key to cover here 
too}
